#include <stdio.h>
/*
 Booksare identified by an International Standard Book Number (ISBN) . ISBNs assigned
...
book (97950 is the code for this book). An ISBN ends with a cheek digit that's used to verify
