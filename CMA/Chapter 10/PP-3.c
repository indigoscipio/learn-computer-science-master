/*
PP 3
Remove the num_in _rank. num_in _suit, and card exists arrays from the
...
hand,then hand[0][0] will store the rankof the first card and hand[0][1] will store
...
// prints classififcation of the hand based on ext vars
void print_result(void){
