...
;;; L-Eval value:
; calls to w
; definition of w to application of (id (id 10))
; if we is called, we evaluate (id 10) -> then (id (id 10))
; calls to id 10 lazily mutates the x's value to 11 -> returns 11
; then it calls id again with (id 11)
; mutates 11 to 12 -> returns 12
1
;;; L-Eval input:
count
;;; L-Eval value:
; calls to the updated count
2