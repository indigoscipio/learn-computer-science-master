...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname exercise-342) (read-case-sensitive #t) (teachpacks ((lib "convert.rkt" "teachpack" "htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp") (lib "web-io.rkt" "teachpack" "2htdp") (lib "abstraction.rkt" "teachpack" "2htdp") (lib "dir.rkt" "teachpack" "htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "convert.rkt" "teachpack" "htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp") (lib "web-io.rkt" "teachpack" "2htdp") (lib "abstraction.rkt" "teachpack" "2htdp") (lib "dir.rkt" "teachpack" "htdp")) #f)))
(require htdp/dir) 
...
;Exercise 339. Design find?. The function consumes a Dir and a file name
;and determines whether or not a file with this name occurs in the directory tree.

; List-of-file.v3 String -> Boolean
; checks if a file with given name s exists in a lof
(define (find-in-files lof s)
  (cond [(empty? lof) #f]
        [(string=? (file-name (first lof)) s) #t]
        [else (find-in-files (rest lof) s)])
  )

; List-of-dirs.v3 String -> Boolean
;checks if a file with the given name s exists in any of the subdirectories
(define (find-in-dirs lod s)
  (cond  ;if any subdirectory contains the file, return true
    [(empty? lod) #f]
    [(find? (first lod) s) #t];if no subdirectory contains the file, reutrns false
    [else (find-in-dirs (rest lod) s)]
    ))
;(find-in-dirs dir-location "text1.txt")
 
 ; Dir.v3 -> Boolean
; seperate the type, is it a file, or is it a directory?
(define (find? dir s)
  (or (find-in-files (dir-files dir) s)
      (find-in-dirs (dir-dirs dir) s))
  )  
;(find? dir-location "KEY.txt")

; A Path is [List-of String].
; interpretation directions into a directory tree

;Exercise 342. Design find. The function consumes a directory d and a file name f.
;If (find? d f) is #true, find produces a path to a file with name f
; otherwise it produces #false.

; Dir.v3 -> List-of-string OR #False
(find dir-location "text3.txt")
