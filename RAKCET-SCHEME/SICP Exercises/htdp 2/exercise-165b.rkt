...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname exercise-165b) (read-case-sensitive #t) (teachpacks ((lib "convert.rkt" "teachpack" "htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "convert.rkt" "teachpack" "htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp")) #f)))
...
(define (wage.v3 an-low)
  (cond [(empty? an-low) '()]
        [else (make-paycheck (paycheck-name (work-name an-low))
                             (paycheck-amount (wage.v2 an-low)))])
  )
