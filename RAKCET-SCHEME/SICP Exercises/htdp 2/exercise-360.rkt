...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname exercise-360) (read-case-sensitive #t) (teachpacks ((lib "convert.rkt" "teachpack" "htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp") (lib "web-io.rkt" "teachpack" "2htdp") (lib "abstraction.rkt" "teachpack" "2htdp") (lib "dir.rkt" "teachpack" "htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "convert.rkt" "teachpack" "htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp") (lib "web-io.rkt" "teachpack" "2htdp") (lib "abstraction.rkt" "teachpack" "2htdp") (lib "dir.rkt" "teachpack" "htdp")) #f)))
...
; Constant definition
; example: (define close-to-pi 3.14)
; Function definition
; example: (define (area-of-circle r) (* close-to-pi (* r r)))

(define-struct bsl-con-def [name value])   ; Represents a constant definition
(define-struct bsl-fun-def [name param body])  ; Represents a function definition

; A BSL-da-all is one of:
; - (make-bsl-con-def Symbol Number)
; - (make-bsl-fun-def Symbol Symbol BSL-fun-expression)
; - (cons BSL-da-all BSL-da-all)  ; A list of definitions


(define con-def-pi (make-bsl-con-def 'close-to-pi 3.14))
(define fun-def-area (make-bsl-fun-def 'area-of-circle 'r (make-mul 'close-to-pi (make-mul 'r 'r))))
(define fun-def-volume (make-bsl-fun-def 'volume-of-10-cylinder 'r (make-mul 10 (make-fun-call 'area-of-circle 'r))))

(define da-all (list con-def-pi fun-def-area fun-def-volume))
