...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname exercise-84) (read-case-sensitive #t) (teachpacks ((lib "convert.rkt" "teachpack" "htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "convert.rkt" "teachpack" "htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp")) #f)))
...
(define (edit ed ke)
  ...
  ; if it's 0, then return current editor state (cursor cant be out of bound or cant delete more 0 string length)
  (cond [(= (string-length (editor-pre ed)) 0) ed]
        [else
  ...
  (if (= (string-length ke) 1)
      ...
      (cond
        ; if it's right or left, do the following
