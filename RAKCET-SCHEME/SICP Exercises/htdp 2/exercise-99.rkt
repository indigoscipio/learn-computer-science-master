...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname exercise-99) (read-case-sensitive #t) (teachpacks ((lib "convert.rkt" "teachpack" "htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "convert.rkt" "teachpack" "htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp")) #f)))
...
(define aim-sample (make-aim (make-posn 100 250) (make-tank 20 TANK-SPEED)))
...
(define (move-proper si delta)
  ...
  (cond
    [(aim? si) (make-aim (make-posn (+ (posn-x (aim-ufo si)) delta) (posn-y (aim-ufo si)) )
    ...
    [(fired? si) (make-fired (make-posn (+ (posn-x (fired-ufo si)) delta) (posn-y (fired-ufo si)))
...
(control (make-aim (make-posn 100 250) (make-tank 20 1)) "left") ; this should be 19
...
(render (make-fired (make-posn 100 50) (make-tank 20 -3) (make-posn 100 35)))
