...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname exercise-229) (read-case-sensitive #t) (teachpacks ((lib "convert.rkt" "teachpack" "htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp") (lib "itunes.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "convert.rkt" "teachpack" "htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp") (lib "itunes.rkt" "teachpack" "2htdp")) #f)))
; An FSM is one of:
;   – '()
;   – (cons Transition FSM)
...
(define sample-fs (make-fs fsm-guess "white"))

 
(define (state-as-colored-square fsm)
  (square 100 "solid" (fs-current fsm)))
...
(define (find-next-state fsm ke)
   (make-fs (fs-fsm fsm) (find (fs-fsm fsm) (fs-current fsm) ke) ))
;(find-next-state sample-fs "a");
