...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname exercise-274) (read-case-sensitive #t) (teachpacks ((lib "convert.rkt" "teachpack" "htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp") (lib "itunes.rkt" "teachpack" "2htdp") (lib "web-io.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "convert.rkt" "teachpack" "htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp") (lib "itunes.rkt" "teachpack" "2htdp") (lib "web-io.rkt" "teachpack" "2htdp")) #f)))
...
(define (prefixes lo1s)
  (local (;List-of-X Number -> List-of-X
          (define (take lo1s n)
            (cond [(= n 0) '()]
                  [(empty? lo1s) '()]
                  [else (cons (first lo1s) (take (rest lo1s) (sub1 n)) ) ])
            )
          ;Number -> Prefix
          (define (get-prefix i)
             (take lo1s i)
             ) ) 
    (build-list (add1 (length lo1s)) get-prefix)
    )
  )
;(prefixes sample-lo1s)
...
(define (suffixes lo1s)
  (local (;List-of-X Number -> List-of-X
          (define (drop lo1s n)
            (cond [(zero? n) lo1s]
                  [(empty? lo1s) '()]
                  [else (drop (rest lo1s) (sub1 n) ) ])
            )
          ;Number -> Prefix
          (define (get-suffix i)
            (drop lo1s i)
            ) ) 
        ;(build-list (add1 (length lo1s)) get-suffix))
