...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname exercise-195) (read-case-sensitive #t) (teachpacks ((lib "convert.rkt" "teachpack" "htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "convert.rkt" "teachpack" "htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp")) #f)))
...
(define (starts-with# l d)
  ;for each list, analyze their first string
  ;if the first string begins with l, increase counter
  ;else recurse
  ;base case is 0 if nothing is found
  (cond [(empty? d) 0]
        [(is-first-letter? (first d) l) (+  (starts-with# l (rest d)) 1)]
        [else (starts-with# l (rest d)) ]) 
  )
(starts-with# "a" DICTIONARY)
(starts-with# "e" DICTIONARY)
(starts-with# "z" DICTIONARY)
