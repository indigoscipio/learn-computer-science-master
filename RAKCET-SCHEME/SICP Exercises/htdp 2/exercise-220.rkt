...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname exercise-220) (read-case-sensitive #t) (teachpacks ((lib "convert.rkt" "teachpack" "htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp") (lib "itunes.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "convert.rkt" "teachpack" "htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp") (lib "itunes.rkt" "teachpack" "2htdp")) #f)))
...
(define (change ws key)
  (cond [(key=? key "left") (if (> (block-x (tetris-block ws)) 0 )
                                                        (make-tetris (make-block (sub1 (block-x (tetris-block ws))) (block-y (tetris-block ws)))
                                                                     (tetris-landscape ws))
                                                         ws )
                            ]
        [(key=? key "right") (if (< (block-x (tetris-block ws)) (- WIDTH 1))
                                 (make-tetris (make-block (add1 (block-x (tetris-block ws))) (block-y (tetris-block ws)) )
                                              (tetris-landscape ws))
                                 ws)]
        [else ws])
  ) 
