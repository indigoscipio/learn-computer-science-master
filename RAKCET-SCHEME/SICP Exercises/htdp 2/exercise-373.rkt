...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname exercise-373) (read-case-sensitive #t) (teachpacks ((lib "convert.rkt" "teachpack" "htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp") (lib "web-io.rkt" "teachpack" "2htdp") (lib "abstraction.rkt" "teachpack" "2htdp") (lib "dir.rkt" "teachpack" "htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "convert.rkt" "teachpack" "htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp") (lib "web-io.rkt" "teachpack" "2htdp") (lib "abstraction.rkt" "teachpack" "2htdp") (lib "dir.rkt" "teachpack" "htdp")) #f)))
...
; XEnum.v2 -> Number
; Counts the occurrences of the word "hello" in an XEnum.v2.
(define (count-hello xe)
  (local ((define content (rest xe))  ; Extract list of XItem.v2
          ; XItem.v2 Number -> Number
          (define (count-item item so-far)
            (+ (count-hello-in-item item) so-far)))
    (foldr count-item 0 content)))

(define (count-hello-in-item item)
  (local ((define content (first (rest item)))) ; Extract content
    (cond
      [(word? content) (if (string=? (word-text content) "hello") 1 0)]
      [else (count-hello content)])))  ; Recursively count in sub-enum
