...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname exercise-235) (read-case-sensitive #t) (teachpacks ((lib "convert.rkt" "teachpack" "htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp") (lib "itunes.rkt" "teachpack" "2htdp") (lib "web-io.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "convert.rkt" "teachpack" "htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp") (lib "itunes.rkt" "teachpack" "2htdp") (lib "web-io.rkt" "teachpack" "2htdp")) #f)))
;Use the contains? function to define functions
;that search for "atom", "basic", and "zoo", respectively.
(define sample-list (list "dog" "cat"))

(define (contains? s l)
  (cond [(empty? l) #false]
        [else (or (equal? s (first l)) (contains? s (rest l))) ])
  )
