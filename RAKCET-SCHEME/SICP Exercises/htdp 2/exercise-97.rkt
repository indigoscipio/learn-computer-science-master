...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname exercise-97) (read-case-sensitive #t) (teachpacks ((lib "convert.rkt" "teachpack" "htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "convert.rkt" "teachpack" "htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp")) #f)))
...
(define aim-sample (make-aim (make-posn 100 250) (make-tank 20 -3)))
...
(define (move-proper si delta)
  ...
  ;if rocket hits ufo, stop moving
  )
(move-proper aim-sample 5)

(define (move si)
  (move-proper si (generate-random-num 50))
  )
