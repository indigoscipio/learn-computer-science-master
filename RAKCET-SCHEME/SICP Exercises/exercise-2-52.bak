...
; transformation that rotate painter counterclockwise by 90deg
(define (rotate-90deg painter)
  (transform-painter painter
                     (make-vect 1.0 0.0)
                     (make-vect 1.0 1.0)
                     (make-vect 0.0 0.0)))
...
; below 1st approach, similar to beside proc
...
;below 2nd approach, using beside and rotation operation
(define (below.v2 painter1 painter2)
  (rotate-90deg (beside (rotate-270deg painter1) (rotate-270deg painter2)))
  )
;(paint (below.v2 wave wave))
